...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
使用示例:
  python ruijie_executor.py --host 192.168.1.1 --username admin --password xxx --commands "show version"
  python ruijie_executor.py --host 192.168.1.1 --username admin --password xxx --query-help "no ip nat"
  python ruijie_executor.py --host 192.168.1.1 --username admin --password xxx --commands "show version" --auto-help
        """
    )
